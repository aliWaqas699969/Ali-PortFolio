          ...
          <div className="my-10">
            ...
            <div className="mt-5">
              ...
              <div className="flex items-center mt-2 space-x-2 text-dark-600 ">
                ...
                <a href="mailto:hello@stablotemplate.com">
                  aliwaqas55488@gmail.com
                </a>
              </div>
              <div className="flex items-center mt-2 space-x-2 text-dark-600 ">
                <svg
                ...
                <a href="tel:+92 3231529432 ">+92 323 1529432</a>
              </div>
            </div>
          </div>
          <div>
            <form className="my-10">
              ...
              <div className="mb-5">
                <input
                  ...
                  autoComplete="false"
                  className="w-full px-4 py-3 border-2 placeholder:text-gray-800 dark:text-white rounded-md outline-none dark:placeholder:text-gray-200 dark:bg-gray-900   focus:ring-4  border-red-600 focus:border-red-600 ring-red-100 dark:ring-0"
                  name="name"
                />
              ...
              <button
                type="submit"
                className="w-full py-4 font-semibol px-7 bg-gradient-to-br from-purple-500 via-blue-500 to-purple-500 hover:bg-slate-800 text-white mt-3  "
              >
                Send Message
              </button>
            </form>
